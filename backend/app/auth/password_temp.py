"""
Temporary password hashing utilities for testing.

This is a temporary implementation that uses hashlib instead of bcrypt
to avoid compatibility issues during development/testing.
"""
